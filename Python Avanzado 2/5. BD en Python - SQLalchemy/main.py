...
def guardar_datos():
    ...
    emilio = Empleado(nombre="Emilio", apellido="Tafur", documento="123", id_departamento=contabilidad.id)
    javier = Empleado(nombre="Javier", apellido="Quiñonez", documento="1234", id_departamento=tecnologia.id)
